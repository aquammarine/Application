import { LlmMessage } from 'src/infra/llm/llm-client.interface';

export const SYSTEM_PROMPT = `You are a friendly and helpful personal assistant for an event management app.
